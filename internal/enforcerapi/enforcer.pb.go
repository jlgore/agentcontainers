...
func (x *PrepareToolCallRequest) GetCorrelationId() string {
	if x != nil {
...
func (x *PrepareToolCallRequest) GetContainerId() string {
	if x != nil {
		return x.ContainerId
	}
	return ""
...
func (x *CompleteToolCallRequest) GetCorrelationId() string {
	if x != nil {
		return x.CorrelationId
	}
	return ""
...
func (x *CompleteToolCallRequest) GetContainerId() string {
	if x != nil {
		return x.ContainerId
	}
	return ""
...
func (x *EnforcementEvent) GetCgroupId() uint64 {
	if x != nil {
		return x.CgroupId
	}
	return 0
...
func (x *EnforcementEvent) GetCorrelationId() string {
	if x != nil {
		return x.CorrelationId
	}
	return ""
...
const file_enforcer_proto_rawDesc = "" +
	...
	"\adetails\x18\a \x03(\v2:.agentcontainers.enforcer.v1.EnforcementEvent.DetailsEntryR\adetails\x12\x1b\n" +
	...
	"\x0fPrepareToolCall\x123.agentcontainers.enforcer.v1.PrepareToolCallRequest\x1a4.agentcontainers.enforcer.v1.PrepareToolCallResponse\x12\x7f\n" +
	"\x10CompleteToolCall\x124.agentcontainers.enforcer.v1.CompleteToolCallRequest\x1a5.agentcontainers.enforcer.v1.CompleteToolCallResponse\x12t\n" +
...
var file_enforcer_proto_goTypes = []any{
	...
	(*PrepareToolCallRequest)(nil),      // 4: agentcontainers.enforcer.v1.PrepareToolCallRequest
	(*PrepareToolCallResponse)(nil),     // 5: agentcontainers.enforcer.v1.PrepareToolCallResponse
	(*CompleteToolCallRequest)(nil),     // 6: agentcontainers.enforcer.v1.CompleteToolCallRequest
	(*CompleteToolCallResponse)(nil),    // 7: agentcontainers.enforcer.v1.CompleteToolCallResponse
	(*NetworkPolicyRequest)(nil),        // 8: agentcontainers.enforcer.v1.NetworkPolicyRequest
